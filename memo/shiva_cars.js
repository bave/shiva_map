...
function createNode(node) {
    var record = "'NODENAME' : [ 'COMMENT' , LAT, LNG, { LINK_KV }, 0, 16, '#FFF', 1, undefined ]";
...
var data = fs.readFileSync('shiva_cars.json');
var cars = JSON.parse(data.toString('utf-8'));
